    ...
    <div className="relative flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-yellow-300 via-white to-white p-8">
      ...
      <div className="flex w-full max-w-lg flex-col items-center rounded-lg bg-white p-8 shadow-lg">
        ...
        <div className="mb-6 flex w-full justify-center space-x-4">
          <span className={`text-md font-medium ${currentStep === 1 ? 'text-yellow-600 border-b-2 border-yellow-600' : 'text-gray-500'}`}>
            1. Account Info
          </span>
          <span className={`text-md font-medium ${currentStep === 2 ? 'text-yellow-600 border-b-2 border-yellow-600' : 'text-gray-500'}`}>
            2. Profile Details
          </span>
        </div>
          ...
          {currentStep === 1 && (
            <>
              ...
              <div className="mt-6 text-sm text-center">
                <Link href="/auth/login" className="font-medium text-yellow-600 hover:text-yellow-500 hover:underline">
            ...
            <>
              ...
              <div className="mt-6 flex justify-between">
                <button
                  ...
                  className="flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm transition-colors hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-300 focus:ring-offset-2"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="mr-2 h-4 w-4"
                ...
                <button
                  type="submit"
                  className="flex justify-center rounded-md border border-transparent bg-yellow-500 px-4 py-2 text-sm font-medium text-gray-800 shadow-sm transition-colors hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2"
                >
                  Create Account
                </button>
              </div>
